...
<div class="row">
    <div class="col-md-12">
        <nav class="navbar navbar-expand-lg navbar-transparent bg-transparent shadow-sm mb-5">
            <img src="{{asset('assets/img/logo7.png')}}" style="width: 50px;">
...
<div class="container-fluid">
    <div class="row mt-5">
            ...
            <div class="card">
                <div class="card-header bg-transparent row" id="bo">
                  ...
                  <div class="col-md-6 text-right">
                    <a href=""><img src="{{asset('assets/img/logo7.png')}}" style="width: 40px;"></a>
                  </div>
                </div>
                <div class="card-body row">
                  ...
                  <div class="col-md-6 my-3">
                    ...
                    <span class="card-text text-success" id="bo">{{ $transaksi->total_bayar }}</span>
                  </div>
                </div>
              </div>
        </div>
        ...
        <div class="col-md-3 offset-md-3">
            <a href="/home" class="btn btn-outline-success btn-block text-success my-3" id="me">Pesan lagi</a>
        </div>
        <div class="col-md-3">
            <a href="{{ route('order.batal',$transaksi->order_detail_id) }}" class="btn btn-success btn-block text-light my-3" id="me">Batalkan pesanan</a>
        </div>
        <div class="col-md-6 offset-md-3 text-center">
            <a href="{{ route('nota',$transaksi->order_detail_id) }}" class="text-success" id="me"><i class="fas fa-file-pdf"></i> Nota kode transaksi</a>
        </div>
  ...
  <footer class="main-footer bg-transparent mt-5">
    <div class="text-center text-secondary py-3">
      <img src="{{asset('assets/img/logo7.png')}}" style="width: 55px;" class="mb-2"><br>
