...
<div class="container-fluid mt-3">
	<div class="row">
		...
		<div class="col-md-10 offset-md-1">
			<div class="owl-carousel owl-theme">
			    <div class="item"><img src="{{asset('assets/img/2.png')}}" style="width:99%"></div>
				<div class="item"><img src="{{asset('assets/img/image4.png')}}" style="width:99%"></div>
	...
	<div class="row mt-5">
	  <div class="col-md-12 text-center">
	    <h1 class="text-success mb-5" id="bo"> Makanan </h1>
	  </div>
	  ...
	  <div class="col-md-6 col-lg-4 col-xl-4  mb-4" >
	    <div class="card-deck" >
			...
			<div class="card shadow-sm" id="card">
				<img src="{{asset('assets/img/produk/'.$key->gambar_masakan)}}" class="img-fluid" alt="...">
			  <div class="card-body">
			  ...
			  <div class="row">
				  <div class="col-md-8">
					  ...
					  @if ($key->status == 'tersedia')
					  		<a class="btn btn-transparent text-success ml-2 my-3" id="sb">Rp. {{ $key->harga }}</a>
							@else
				  ...
				  <div class="col-md-4 text-right">
					<form action="/pesan_order" method="POST">
						...
						@if ($key->status == 'tersedia')
							<button type="submit" class="btn btn-success text-right mr-3 my-3" id="btn-shop"><i class="fas fa-shopping-cart"></i></button>
							@else
							<button type="button" class="btn btn-danger text-right mr-3 my-3" id="btn-shop1" disabled> <b>HABIS</b> </button>
						@endif
	...
	<div class="row mt-5">
		<div class="col-md-12 text-center">
		  <h1 class="text-success mb-5" id="bo"> Minuman </h1>
		</div>
	...
	<div class="row mt-5">
		<div class="col-md-12 text-center">
		  <h1 class="text-success mb-5" id="bo"> Cemilan </h1>
		</div>
    ...
    <div class="row pb-5" >
		<div class="text-center col-md-10 offset-md-1">
			<h1 class="text-success my-5" id="bo">PESANAN</h1>
		</div>
        ...
        <div class="col-lg-7 offset-lg-1">
			<div class="row shadow p-3" style="background-color: #ffffff;" id="card-cart"> 
				...
				<div class="col-md-4 my-auto">
					...
					<span id="me" class="text-success">Rp {{ $item->harga }}</span>
				</div>
				...
				<div class="card-body">
					<form action="/order_bayar" class="row" method="POST">
						...
						<div class="col-md-6 text-right">
							<span class="text-success" id="bo">Rp. {{$order->sum('sub_total')}}</span>
						</div>														<input type="hidden" id="total" value="{{$order->sum('sub_total')}}" class="total" name="total_bayar">
						<div class="col-md-12"><hr></div>
						<div class="col-md-12">
							<button class="btn btn-primary btn-sm btn-block btn-success py-2" id="bayar"><i class="fas fa-shopping-cart fas-2x"></i> Checkout</button>		
						</div>
					</form>
				</div>
			</div>
