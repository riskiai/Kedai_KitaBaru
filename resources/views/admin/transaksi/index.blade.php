...
<div class="container-fluid mt-3">
	<div class="row">
		<div class="col-md-6">
			<img src="{{ asset('assets/img/logo7.png') }}" style="width: 100px;" alt="">
		</div>
		<div class="col-md-6 text-right">
			<span id="me" class="text-success">KASIR</span><br>
			<span class="text-success"><i class="fas fa-user"></i> KEDAI KITA</span>
		</div>
			...
			<div class="row">
				<form action="{{ route('order.bayar',$transaksi2->order_detail_id) }}" method="POST" class="row">
					...
					<div class="col-md-12 text-center mt-3">
						<a href="/transaksi" class="text-success" id="bo">X Clear</a>
					</div>
				</form>
			</div>
		</div>
