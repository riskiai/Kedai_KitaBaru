      ...
      <div class="card mt-3">
        <div class="card-header row my-auto">
          ...
          <div class="col-md-6 justify-content-end">
            ...
            <a href="/orderan_belum" class="btn btn-success mr-2">Belum dibayar</a>
            <a href="/orderan_batal" class="btn btn-outline-success">Dibatalakan</a>
            <a href="/orderan_belum_diantar" class="btn btn-outline-success mr-2">Belum diantar</a>
            <a href="/orderan" class="btn btn-outline-success mr-2">Selesai</a>
          </div>
        </div>
          <div class="card-body">
            @if(session('message'))
                  ...
                  <tbody class="mt-2">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('batal',$item->id_transaksi) }}" class="btn btn-success btn-block confirm_script mb-2">Batal</a>
                      </td>
                  </tr>
                    @endforeach
                  </tbody>
