      ...
      <div class="card mt-3">
        <div class="card-header row my-auto">
          ...
          <div class="col-md-6 justify-content-end">
            ...
            <a href="/orderan_belum" class="btn btn-outline-success mr-2">Belum dibayar</a>
            <a href="/orderan_batal" class="btn btn-success">Dibatalakan</a>
              ...
              <table class="table table-md table-striped">
                  ...
                  <tbody class="mt-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" data-id="" class="btn btn-success confirm_script-{{$item->order_detail_id}} mr-3">
