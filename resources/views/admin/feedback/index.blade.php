            ...
            <div class="float-right">
              <form action="?" method="GET">
                <div class="input-group mb-3">
                  ...
                  <a href="/delete-all" class="btn btn-success ml-3 d-flex">Hapus semua</a>
                </div>
              </form>
            </div>
          </div>
                  ...
                  <tbody class="mt-2">
                   ...
                   @foreach ($data as $item)
                    <tr>
                        ...
                        <td> {{ $item->tanggal }}</td>
                        <td>
                          <a href="#" data-id="{{ $item->id_feedback }}" class="btn btn-success confirm_script" title="Hapuss">
