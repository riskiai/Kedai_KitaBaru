...
<body>
	<div class="container-fluid mt-3">
		<div class="row">
			<div class="col-md-6">
				<img src="{{ asset('assets/img/logo7.png') }}" style="width: 55px;" alt="">
			</div>
			<div class="col-md-6 text-right">
				<span id="me" class="text-success">KASIR</span><br>
				<a href="/logout" class="text-success"><i class="fas fa-user"></i> {{ Auth::guard('kasir')->user()->nama_kasir }}</a>
			</div>
			<div class="col-md-6 offset-md-1 mb-5 mt-5">
				<a href="/kasir_laporan" class="btn btn-success mb-3">Cetak laporan</a>
				...
				<div class="row">
					<form action="{{ route('kasir.bayar',$transaksi2->order_detail_id) }}" method="POST" class="row">
						...
						<div class="col-md-12">
							<div class="input-group input-group-sm mb-3">
							  <div class="input-group-prepend">
								<span class="input-group-text" id="inputGroup-sizing-sm" target="_blank">Bayar</span>
						...
						<div class="col-md-12 text-center mt-3">
							<a href="/kasir" class="text-success" id="bo">X Clear</a>
						</div>
					</form>
				</div>
			</div>
