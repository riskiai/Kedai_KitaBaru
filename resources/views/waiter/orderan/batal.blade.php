      ...
      <div class="card mt-3">
        <div class="card-header row my-auto">
          <div class="col-md-6 mt-2">
            <h5 class="text-success">Batal</h5>
          </div>
          <div class="col-md-6 justify-content-end">
           
           
            <a href="/waiter_belum" class="btn btn-outline-success mr-2">Belum dibayar</a>
            <a href="/waiter_batal" class="btn btn-success">Dibatalakan</a>
            <a href="/waiter_belum_diantar" class="btn btn-outline-success mr-2">Belum diantar</a>
            <a href="/waiter" class="btn btn-outline-success mr-2">Selesai</a>
          </div>
        </div>
          <div class="card-body">
            @if(session('message'))
              ...
              <table class="table table-md table-striped">
                  ...
                  <tbody class="mt-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('waiter.order.delete',$item->order_detail_id) }}" class="btn btn-success btn-block my-2"><i class="fas fa-trash"></i></a>
                      </td>
                  </tr>
                    @endforeach
                  </tbody>
