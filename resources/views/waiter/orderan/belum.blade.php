      ...
      <div class="card mt-3">
        <div class="card-header row my-auto">
          <div class="col-md-6 mt-2">
            <h5 class="text-success">Belum dibayar</h5>
          </div>
          <div class="col-md-6 justify-content-end">
            
            <a href="/waiter_belum" class="btn btn-success mr-2">Belum dibayar</a>
            <a href="/waiter_batal" class="btn btn-outline-success">Dibatalakan</a>
              ...
              <table class="table table-md table-striped">
                  ...
                  <tbody class="mt-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('waiter.batalkan',$item->id_transaksi) }}" class="btn btn-success btn-block confirm_script mb-2">Batal</a>
                      </td>
                  </tr>
                    @endforeach
                  </tbody>
